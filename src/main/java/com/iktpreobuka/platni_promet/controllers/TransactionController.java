package com.iktpreobuka.platni_promet.controllers;
...
import com.iktpreobuka.platni_promet.repositories.TransactionRepository;
import com.iktpreobuka.platni_promet.services.TransactionService;
...
public class TransactionController {
	...
	@RequestMapping(method = RequestMethod.GET, value = "/by/{bankName}")
	 ...
	 * 
	 * NAMA NE TREBA PUT NA TRANSAKCIJU, JER NE SME DA POSTOJI MOGUCNOST PROMENE
	 * VEC IZVRSENE TRANSAKCIJE
	 * 
	 ...
	 * 
	 * NAMA NE TREBA DELETE ZA TRANSAKCIJU, JER NEMA POTREBE DA SE OBRISU VEC
