...
public class ClientEntity {
	 ...
	 * = { CascadeType.REFRESH })
	 * 
	 * @JsonView(Views.Client.class) private List<TransactionEntity>
	...
	public ClientEntity(String name, String surname, String password, String email, AddressEntity address,
			BankEntity bank) {
		super();
		this.name = name;
		this.surname = surname;
